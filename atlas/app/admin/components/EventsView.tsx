// app/admin/components/EventsView.tsx
"use client";

import React from 'react';
import { motion } from 'framer-motion';
import { Calendar, MapPin, User, FileText, Trash2 } from 'lucide-react';
...
const EventsView: React.FC<EventsViewProps> = ({ events, onDelete }) => {
  ...
  return (
    ...
    >
      <div className="grid grid-cols-6 gap-6 px-6 py-4 border-b-2 border-gray-100">
